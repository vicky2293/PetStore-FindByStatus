...
- HTML report is available as artifacts in GitHub actions (At the bottom of the workflow summary page, there is a dedicated section for artifacts.)
- Refer screenshot - [Artifact](https://ibb.co/VQrV2mt)
